...
**최신 채택 기준: `B_STAGE66_APPROVED_20260907.md`. B 운영 ID `b_profit_lock_stage66`: Stage45의 12종목 진입을 그대로 유지하고 ICP/BCH/UNI에 인과적 수익보호 청산을 결합한다. A는 변경하지 않는다. 사용자 B ON·LIVE 상태는 변경하지 않는다. 아래 Stage45/Stage35/Stage26/Stage16 기록은 과거 이력이다.**
