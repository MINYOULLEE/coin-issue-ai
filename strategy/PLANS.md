...
2026-09-01 반복 뉴스 알림·로컬 수집기 점검: `ALERT_STARTUP_REPAIR_20260901.md`. 뉴스에만 지속 실패/복구 확인을 적용하며 매매 오류 알림은 즉시 유지. 로컬 작업은 종료했지만 자동시작 비활성화는 Windows 관리자 권한이 필요하여 미완료다.
