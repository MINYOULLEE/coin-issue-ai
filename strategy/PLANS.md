...
## A플랜: Stage126 선택적 리사이즈 — 2026-09-10 사용자 채택

- 정본: `strategy/mdd30_standard.json`
- ID: `answer_mdd30`, 버전 `mdd30_selective_resize_stage126_v1`
...
- 채택 연구 결과: 5년 +5,028,269.99%, 7년 +5,715,948.26%, 7년 최대낙폭 -51.22%, 9,458 이벤트, 비용 3배 +1,076,691.27%. 1시간 지연과 비용 3배 동시 조건은 +862,789.21%로 연구 합격선 100만%에 미달한다는 점을 사용자에게 공개한 뒤 채택되었다. 과거 연구는 미래·실거래 성과 보장이 아니다. `strategy/A_STAGE126_APPROVED_20260910.md` 참조.
