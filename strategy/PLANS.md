...
**최신 채택 기준: `B_STAGE93_APPROVED_20260909.md`. B 운영 ID `b_algo_ada_stage93`: Stage66을 유지하고 ALGO 거래량 문턱을 1.0배로 교정하며 ADA UTC 06~08시 3% 충격 반전 보조를 추가한다. A는 변경하지 않는다. 사용자 B ON·LIVE 상태는 변경하지 않는다. 아래 Stage66/Stage45/Stage35/Stage26/Stage16 기록은 과거 이력이다.**

## A플랜: Stage75 운영 배포 완료

- 정본: `strategy/mdd30_standard.json`
- ID: `answer_mdd30`, 버전 `mdd30_drawdown_guard_stage75_v1`
