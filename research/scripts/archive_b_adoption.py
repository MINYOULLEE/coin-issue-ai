...
def main():
    ...
    manifest=dict(created_at=datetime.now(timezone.utc).isoformat(),adopted_version='b_core_sparse_stage26_v1',
        ...
        status='Stage26 runtime, contract alignment and Telegram approved deployment complete; consult B_STAGE26_APPROVED_20260831.md; owner switches unchanged; live performance not certified',
