...
alter table public.trade_signals add constraint trade_signals_signal_type_check check (
  signal_type = any (array['swing','tactical','candidate_a_big','candidate_a_small','research_a_big','research_a_small','strategy_a','strategy_b','strategy_c','strategy_d','strategy_f','strategy_g','answer_mdd30']::text[])
);
