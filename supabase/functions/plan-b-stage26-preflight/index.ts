...
Deno.serve(async req=>{
 ...
 try{
  ...
  return Response.json({ok:results.every(r=>r.ok)&&String(mode.dualSidePosition)==='true',plan:'B',mode:'read_only_stage93_preflight',hedge_mode:mode.dualSidePosition,results,orders_submitted:0});
